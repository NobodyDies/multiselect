<div align="center">
  ...
  ## this is a fork of <a href="https://www.npmjs.com/package/@vueform/multiselect" target="_blank">@vueform/multiselect</a>. For this moment it just solves issue with custom component fow wrapping options list and not fully tested
...
| **listWrapperComponent** | `{object} {template: '<slot></slot>'}` | Component that wraps entire options list, can provide it's own slots with prefix 'list-wrapper-' in name. Should provide default slot.                                                                                                                                                                                                                                                                                                                                                                                          |
| **hideOnBlur**           | `{boolean} false`                      | Should multiselect close on blur or this behavior should provide user or his listWrapperComponent.                                                                                                                                                                                                                                                                                                                                                                                                                              | 
| **useInputForValue**     | `{boolean} false`                      | Should multiselect always show value in input. Use for **searchable** to modify selected value                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **sort**                   | `{Function} null`                      | Function to sort displayed values in multiselect                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
